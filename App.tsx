    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-slate-800">
                Сервис для первичного скрининга рекламных текстов
              </h1>
        ...
        {result && (
          <div className="mt-7 space-y-5">
            ...
            {result.manipulationViolations.length > 0 && (
              <ViolationsCard
                title="Скрытая реклама или манипуляции"
                icon={
                  <svg
                ...
                colorScheme="amber"
                generateMessage={(count, phrases) =>
                  `В тексте зафиксировано ${count} потенциальных нарушений, относящихся к категории скрытой рекламы или манипуляций пользователем. Среди нарушений фраза(ы): ${phrases
                    .map((p) => `«${p}»`)
                    .join(", ")}. Рекомендуется проверить выделенный(е) фрагмент(ы) и отредактировать их для приведения текста в соответствие с требованиями ФЗ «О рекламе».`
                }
              />
          ...
          <div className="grid sm:grid-cols-2 gap-6 text-sm text-slate-600 leading-relaxed">
            <div>
              ...
              <ul className="space-y-1.5">
                ...
                <li className="flex items-start gap-2">
                  ...
                  Манипулятивные приёмы и скрытую рекламу (только сегодня,
                  последний шанс и др.)
                </li>
              </ul>
            </div>
            <div>
              ...
              <p>
                ...
                квалифицироваться как недостоверная, недобросовестная или
                скрытая реклама. Результаты носят рекомендательный характер.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="mt-12 border-t border-slate-200 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-5 text-center text-sm text-slate-400">
          Сервис для первичного скрининга рекламных текстов — инструмент предварительной проверки.
